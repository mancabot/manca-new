...
const MANCA-NEW = '『MANCA-BOT』'; 
const instagram = 'https://www.instagram.com/thenay_xploit_'; 
const nomer = 'Wa.me/6283815956151'; 
const aktif = 'Tergantung kuota/wifi'; 
const groupwhatsapp = 'https://chat.whatsapp.com/JL2P1ez4crxC9mFIVlmZEf'; 
const no-bot = 'https://wa.me/994404762586'; 
...
conn.sendMessage(id, ' *Owner Nurul Cans Wa.me/6283815956151* ' ,MessageType.text);
}
else if (text == '#creator'){
conn.sendMessage(id, ' *Creator Nurul Cans Wa.me/6283815956151* ' ,MessageType.text);
}
else if (text == 'Pagi'){
...
conn.sendMessage(id, lobby.lobby(id, MANCA-NEW, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, no-bot) ,MessageType.text);
}
if (text == '#edukasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, edu.edu(id, MANCA-NEW, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, no-bot) ,MessageType.text);
}
if (text == '#media'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, media.media(id, MANCA-NEW, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, no-bot) ,MessageType.text);
}
if (text == '#ownerinfo'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, owner.owner(id, MANCA-NEW, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, no-bot) ,MessageType.text);
}
if (text == '#changelog'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, cl.cl(id, MANCA-NEW, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, no-bot) ,MessageType.text);
}
if (text == '#other'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, other.other(id, MANCA-NEW, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, no-bot) ,MessageType.text);
}
else if (text == '#donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id, MANCA-NEW, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, no-bot) ,MessageType.text);
}
else if (text == '#donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id, MANCA-NEW, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, no-bot) ,MessageType.text);
}
else if (text == '#foto'){
